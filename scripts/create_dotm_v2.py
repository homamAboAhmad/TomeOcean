...
Sub TheLibraryPrepareDoc()
    ...
    On Error GoTo 0
    doc.CustomDocumentProperties.Add Name:="TheLibraryResult", _
...
try:
    ...
    mod.Name = "TheLibraryHelper"
    mod.CodeModule.AddFromString(VBA_CODE.strip())
    print(f"VBA module added: {mod.Name}")
except Exception as e:
    print(f"ERROR adding VBA: {e}")
    try:
        doc.Close(False)
    except:
        pass
...
try:
    ...
    pass
print(f"Saved: {dotm_path} ({os.path.getsize(dotm_path)} bytes)")
