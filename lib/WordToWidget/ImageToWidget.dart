...
getImageWidget(ImageData? imageData) {
  ...
  if (usesVAlign && image.alingV == "center") {
    ...
    if (image.relativeFromV == "page" ||
      ...
      // page: نسبي لأعلى الصفحة
      // paragraph: نسبي للفقرة (يُعالج في مكان آخر)
      // topMargin: نسبي لأعلى الهامش (بداية منطقة المحتوى) - لا نضيف topMargin
      posY = image.posY;
    } else {
      // margin: نسبي لمنطقة الهامش (نضيف topMargin)
